...
async function installClaudeCode() {
  ...
  try {
    ...
    await execAsync('npm install -g @anthropic-ai/claude-code --loglevel=error');
...
async function installCodex() {
  ...
  try {
    ...
    await execAsync('npm install -g @openai/codex --loglevel=error');
...
async function installOpenCode() {
  ...
  try {
    ...
    await execAsync('npm install -g opencode-ai --loglevel=error');
